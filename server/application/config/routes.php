...
$route['payment/bank/(:num)']['PUT'] = 'api/payment/bank/$1';
$route['payment/canceled/(:num)']['PUT'] = 'api/payment/canceled/$1';
$route['payment/receipt/(:num)']['PUT'] = 'api/payment/receipt/$1';
$route['payment/transfer']['PUT'] = 'api/payment/transfer';
$route['payment/verified/(:num)']['PUT'] = 'api/payment/verified/$1';
